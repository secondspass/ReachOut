        ...
        <ScrollView style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionDescription}>
              Create a backup file that you can save to your device or cloud
              storage.
            </Text>
            <TouchableOpacity
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.infoText}>
              ...
              including names, contact preferences, and last contact dates are
              included{"\n"}• Backup files can be shared via email, cloud
              storage, or other apps{"\n"}• Keep your backup files safe and
              secure
            </Text>
          </View>
        </ScrollView>
